...
//
//     final pokemonBiology = pokemonBiologyFromJson(jsonString);

import 'dart:convert';

PokemonBiology pokemonBiologyFromJson(String str) =>
    PokemonBiology.fromJson(json.decode(str));

String pokemonBiologyToJson(PokemonBiology data) => json.encode(data.toJson());

class PokemonBiology {
  int baseHappiness;
  int captureRate;
  Color color;
  ...
  factory PokemonBiology.fromJson(Map<String, dynamic> json) => PokemonBiology(
        baseHappiness:
